...
const InformationTechnologyProgramme = () => {
  ...
  const courseHighlights = [
    { icon: Clock, text: "12-18 Months Duration" },
    { icon: Users, text: "Live Project Training" },
    { icon: Award, text: "Industry Certification" },
    { icon: BookOpen, text: "Comprehensive IT Curriculum" }
  ];
          ...
          <div className="relative z-10 container mx-auto px-4 text-center text-white">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
                Comprehensive IT training covering all aspects of information technology
              </p>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our IT Programme provides comprehensive training in all areas of information technology.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Code, title: "System Administration", desc: "Windows & Linux systems" },
                { icon: Target, title: "Networking", desc: "Network setup & management" },
                { icon: TrendingUp, title: "Security", desc: "IT security & cyber security" },
                { icon: Star, title: "Support", desc: "IT help desk & support" }
              ].map((item, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-xl mb-8 max-w-2xl mx-auto">
                Join our comprehensive program and become a skilled IT professional.
              </p>
