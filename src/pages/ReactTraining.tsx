...
const ReactTraining = () => {
  ...
  const courseHighlights = [
    ...
    { icon: BookOpen, text: "React Curriculum" }
  ];
          ...
          <div className="relative z-10 container mx-auto px-4 text-center text-white">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
                Master React.js for building modern, interactive web applications
              </p>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our React Training program covers modern React development with hooks, state management, and best practices.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Code, title: "React Fundamentals", desc: "Components & JSX" },
                { icon: Target, title: "Hooks & State", desc: "Modern React patterns" },
                { icon: TrendingUp, title: "State Management", desc: "Redux & Context API" },
                { icon: Star, title: "Real Projects", desc: "Industry applications" }
              ].map((item, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-xl mb-8 max-w-2xl mx-auto">
                Join our comprehensive program and become a skilled React developer.
              </p>
