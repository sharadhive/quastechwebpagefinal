...
const PythonDevelopmentTraining = () => {
  ...
  const courseHighlights = [
    ...
    { icon: BookOpen, text: "Core Python Curriculum" }
  ];
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our Python Development Training program covers core Python concepts and practical development skills.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Code, title: "Core Python", desc: "Fundamentals & OOPs" },
                { icon: Target, title: "Advanced Concepts", desc: "Data Structures & Algorithms" },
                { icon: TrendingUp, title: "Web Development", desc: "Flask & API Development" },
                { icon: Star, title: "Project Development", desc: "Real-world applications" }
              ].map((item, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-xl mb-8 max-w-2xl mx-auto">
                Join our comprehensive program and become a skilled Python developer.
              </p>
