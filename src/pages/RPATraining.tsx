...
const RPATraining = () => {
  ...
  const courseHighlights = [
    { icon: Clock, text: "2-4 Months Duration" },
    { icon: Users, text: "Live Project Training" },
    { icon: Award, text: "Industry Certification" },
    { icon: BookOpen, text: "RPA Curriculum" }
  ];

  const curriculum = [
    "RPA Fundamentals & Concepts",
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background">
          ...
          <div className="relative z-10 container mx-auto px-4 text-center text-white">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
                Master Robotic Process Automation for business process optimization
              </p>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our RPA Training program covers automation tools and techniques for streamlining business processes.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Code, title: "RPA Tools", desc: "UiPath, Automation Anywhere" },
                { icon: Target, title: "Process Automation", desc: "Business process optimization" },
                { icon: TrendingUp, title: "Bot Development", desc: "Create intelligent bots" },
                { icon: Star, title: "Real Projects", desc: "Industry automation" }
              ].map((item, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 via-purple-600 to-orange-500">
          <div className="container mx-auto px-4 text-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-extrabold mb-6">
                Ready to Master RPA Development?
              </h2>
              <p className="text-xl mb-8 max-w-2xl mx-auto">
                Join our comprehensive program and become a skilled RPA developer.
              </p>
