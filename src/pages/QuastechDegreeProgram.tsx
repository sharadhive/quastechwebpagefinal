...
const QuastechDegreeProgram = () => {
  ...
  const courseHighlights = [
    { icon: Clock, text: "3 Years Duration" },
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background">
          ...
          <div className="relative z-10 container mx-auto px-4 text-center text-white">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
                Industry-focused degree program with practical training and placement assistance
              </p>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our Quastech Degree Program combines academic excellence with industry-relevant skills and practical training.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Code, title: "Full Stack Development", desc: "Frontend & Backend technologies" },
                { icon: Target, title: "Mobile Development", desc: "iOS & Android apps" },
                { icon: TrendingUp, title: "AI & ML", desc: "Machine Learning basics" },
                { icon: Star, title: "Placement Support", desc: "100% placement assistance" }
              ].map((item, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 via-purple-600 to-orange-500">
          <div className="container mx-auto px-4 text-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-extrabold mb-6">
                Ready to Join Quastech Degree Program?
              </h2>
              <p className="text-xl mb-8 max-w-2xl mx-auto">
                Join our industry-focused program with guaranteed placement assistance and practical training.
              </p>
