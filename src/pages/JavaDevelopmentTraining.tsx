...
const JavaDevelopmentTraining = () => {
  ...
  const courseHighlights = [
    ...
    { icon: BookOpen, text: "Core Java Curriculum" }
  ];
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our Java Development Training program covers core Java concepts and advanced programming techniques.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Code, title: "Core Java", desc: "Fundamentals & OOPs" },
                { icon: Target, title: "Advanced Concepts", desc: "Collections, Multithreading" },
                { icon: TrendingUp, title: "Database Connectivity", desc: "JDBC & SQL" },
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-xl mb-8 max-w-2xl mx-auto">
                Join our comprehensive program and become a skilled Java developer.
              </p>
