...
const PlacementPage = () => {
  ...
  const placementStats = [
    ...
    { icon: Target, value: "800+", label: "Hiring Partners", color: "from-purple-500 to-pink-500" },
    { icon: Star, value: "15+", label: "Years of Excellence", color: "from-orange-500 to-red-500" }
  ];
  ...
  const topCompanies = [
    ...
    "Amazon", "Google", "HCL", "Tech Mahindra", "Cognizant", "Capgemini"
  ];
  ...
  return (
    <DarkModeProvider>
      <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background">
        ...
        {/* Hero Section with Placement Banner */}
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
          {/* Background Image */}
          <div 
            className="absolute inset-0 bg-cover bg-center bg-no-repeat"
            style={{
              backgroundImage: "url('/images/bg-placement.gif')",
            }}
          />
          ...
          <div className="relative z-10 container mx-auto px-4 text-center text-white">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
                We ensure 100% placement assistance with top companies
              </p>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                We have successfully placed thousands of students in top companies across India.
              </p>
            </motion.div>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-xl mb-8 max-w-2xl mx-auto">
                Join our programs and get guaranteed placement assistance with top companies.
              </p>
