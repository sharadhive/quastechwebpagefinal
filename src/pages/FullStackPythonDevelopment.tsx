...
const FullStackPythonDevelopment = () => {
  ...
  const courseHighlights = [
    { icon: Clock, text: "6-8 Months Duration" },
    { icon: Users, text: "Live Project Training" },
    { icon: Award, text: "Industry Certification" },
    { icon: BookOpen, text: "Full Stack Curriculum" }
  ];
  ...
  const curriculum = [
    ...
    "Flask Framework",
    "RESTful APIs with Django/Flask",
          ...
          <div className="relative z-10 container mx-auto px-4 text-center text-white">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
                Master Python ecosystem from backend to frontend development
              </p>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our Full Stack Python Development program covers everything from core Python to modern frameworks, preparing you for real-world development.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Code, title: "Backend Development", desc: "Python, Django, Flask" },
                { icon: Target, title: "Frontend Integration", desc: "React.js, HTML, CSS, JS" },
                { icon: TrendingUp, title: "API Development", desc: "RESTful services" },
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-xl mb-8 max-w-2xl mx-auto">
                Join our comprehensive program and master the complete Python ecosystem.
              </p>
