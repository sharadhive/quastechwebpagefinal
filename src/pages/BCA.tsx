...
const BCA = () => {
  ...
  const courseHighlights = [
    ...
    { icon: Award, text: "UGC Recognized Degree" },
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our BCA program provides comprehensive education in computer applications with industry-relevant curriculum.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Code, title: "Programming", desc: "Multiple programming languages" },
                { icon: Target, title: "Database Systems", desc: "DBMS & SQL" },
                { icon: TrendingUp, title: "Web Development", desc: "Frontend & Backend" },
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-xl mb-8 max-w-2xl mx-auto">
                Join our UGC recognized BCA program and build a strong foundation in computer applications.
              </p>
