...
const Taxation = () => {
  ...
  const courseHighlights = [
    ...
    { icon: BookOpen, text: "Taxation Curriculum" }
  ];

  const curriculum = [
    "Income Tax Fundamentals",
    "Direct Tax Laws & Provisions",
          ...
          <div className="relative z-10 container mx-auto px-4 text-center text-white">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
                Master taxation laws and become a tax professional
              </p>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our Taxation program covers comprehensive tax laws, compliance, and advisory services.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Code, title: "Tax Laws", desc: "Income Tax & GST" },
                { icon: Target, title: "Compliance", desc: "Tax filing & returns" },
                { icon: TrendingUp, title: "Planning", desc: "Tax planning strategies" },
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {careerOpportunities.map((role, index) => (
                  ...
                  >
                    ...
                    <p className="text-gray-600 text-sm">High demand role in tax industry</p>
                  </motion.div>
                ))}
              </div>
            </div>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-xl mb-8 max-w-2xl mx-auto">
                Join our comprehensive program and become a skilled tax professional.
              </p>
