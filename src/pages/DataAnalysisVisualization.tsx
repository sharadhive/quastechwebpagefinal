...
const DataAnalysisVisualization = () => {
  ...
  const courseHighlights = [
    { icon: Clock, text: "4-6 Months Duration" },
    { icon: Users, text: "Live Project Training" },
    { icon: Award, text: "Industry Certification" },
    { icon: BookOpen, text: "Data Analysis Curriculum" }
  ];
          ...
          <div className="relative z-10 container mx-auto px-4 text-center text-white">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
                Master data analysis and create stunning visualizations with Python
              </p>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our Data Analysis & Visualization program teaches you to extract insights from data and create compelling visualizations.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Code, title: "Python Analysis", desc: "Pandas, NumPy, Statistics" },
                { icon: Target, title: "Data Visualization", desc: "Matplotlib, Seaborn, Plotly" },
                { icon: TrendingUp, title: "BI Tools", desc: "Tableau, Power BI" },
                { icon: Star, title: "Real Projects", desc: "Industry datasets" }
              ].map((item, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {careerOpportunities.map((role, index) => (
                  ...
                  >
                    ...
                    <p className="text-gray-600 text-sm">High demand role in data industry</p>
                  </motion.div>
                ))}
              </div>
            </div>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-xl mb-8 max-w-2xl mx-auto">
                Join our comprehensive program and become a skilled data analyst.
              </p>
