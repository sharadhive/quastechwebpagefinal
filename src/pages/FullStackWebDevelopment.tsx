          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our Full Stack Web Development program covers modern technologies and frameworks for complete web application development.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Code, title: "Frontend Development", desc: "React.js, HTML, CSS, JS" },
                { icon: Target, title: "Backend Development", desc: "Node.js, Express.js" },
                { icon: TrendingUp, title: "Database Management", desc: "MongoDB, SQL" },
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-xl mb-8 max-w-2xl mx-auto">
                Join our comprehensive program and master modern web development technologies.
              </p>
