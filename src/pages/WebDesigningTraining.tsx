          ...
          <div className="relative z-10 container mx-auto px-4 text-center text-white">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
                Master modern web design with HTML, CSS, and creative tools
              </p>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our Web Designing Training program covers modern design principles and practical web development skills.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Code, title: "HTML & CSS", desc: "Fundamentals & Advanced" },
                { icon: Target, title: "UI/UX Design", desc: "User Interface Design" },
                { icon: TrendingUp, title: "Responsive Design", desc: "Mobile-first approach" },
                { icon: Star, title: "Creative Tools", desc: "Photoshop & Illustrator" }
              ].map((item, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
