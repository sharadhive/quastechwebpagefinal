...
const GraphicDesigning = () => {
  ...
  const courseHighlights = [
    ...
    { icon: BookOpen, text: "Design Curriculum" }
  ];
          ...
          <div className="relative z-10 container mx-auto px-4 text-center text-white">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
                Master graphic design tools and create stunning visual content
              </p>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our Graphic Designing program covers professional design tools and creative techniques.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Code, title: "Adobe Suite", desc: "Photoshop, Illustrator, InDesign" },
                { icon: Target, title: "Design Principles", desc: "Typography, Color Theory" },
                { icon: TrendingUp, title: "Branding", desc: "Logo & Identity Design" },
                { icon: Star, title: "Portfolio", desc: "Professional portfolio" }
              ].map((item, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {careerOpportunities.map((role, index) => (
                  ...
                  >
                    ...
                    <p className="text-gray-600 text-sm">High demand role in creative industry</p>
                  </motion.div>
                ))}
              </div>
            </div>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-xl mb-8 max-w-2xl mx-auto">
                Join our comprehensive program and become a skilled graphic designer.
              </p>
