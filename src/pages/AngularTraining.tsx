...
const AngularTraining = () => {
  ...
  const courseHighlights = [
    { icon: Clock, text: "3-5 Months Duration" },
    { icon: Users, text: "Live Project Training" },
    { icon: Award, text: "Industry Certification" },
    { icon: BookOpen, text: "Angular Curriculum" }
  ];

  const curriculum = [
    "Angular Fundamentals & TypeScript",
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background">
          ...
          <div className="relative z-10 container mx-auto px-4 text-center text-white">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
                Master Angular framework for building enterprise-grade web applications
              </p>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our Angular Training program covers modern Angular development with TypeScript and enterprise patterns.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Code, title: "Angular Framework", desc: "Components & Services" },
                { icon: Target, title: "TypeScript", desc: "Type-safe development" },
                { icon: TrendingUp, title: "RxJS & Observables", desc: "Reactive programming" },
                { icon: Star, title: "Enterprise Apps", desc: "Real-world projects" }
              ].map((item, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 via-purple-600 to-orange-500">
          <div className="container mx-auto px-4 text-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-extrabold mb-6">
                Ready to Master Angular Development?
              </h2>
              <p className="text-xl mb-8 max-w-2xl mx-auto">
                Join our comprehensive program and become a skilled Angular developer.
              </p>
