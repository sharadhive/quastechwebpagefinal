      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background">
          ...
          <div className="relative z-10 container mx-auto px-4 text-center text-white">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
                Master financial accounting principles and practices
              </p>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our Financial Accounting program covers fundamental accounting principles and financial statement preparation.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Code, title: "Bookkeeping", desc: "Double entry system" },
                { icon: Target, title: "Financial Statements", desc: "P&L, Balance Sheet, Cash Flow" },
                { icon: TrendingUp, title: "Analysis", desc: "Financial ratios & analysis" },
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {careerOpportunities.map((role, index) => (
                  ...
                  >
                    ...
                    <p className="text-gray-600 text-sm">High demand role in finance industry</p>
                  </motion.div>
                ))}
              </div>
            </div>
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 via-purple-600 to-orange-500">
          <div className="container mx-auto px-4 text-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-extrabold mb-6">
                Ready to Master Financial Accounting?
              </h2>
