...
const DataScienceWithPython = () => {
  ...
  const courseHighlights = [
    ...
    { icon: BookOpen, text: "Data Science Curriculum" }
  ];
          ...
          <div className="relative z-10 container mx-auto px-4 text-center text-white">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
                Master data science and machine learning with Python
              </p>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our Data Science with Python program covers everything from data analysis to machine learning and deep learning.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Code, title: "Data Analysis", desc: "Pandas, NumPy, Statistics" },
                { icon: Target, title: "Machine Learning", desc: "Algorithms & Models" },
                { icon: TrendingUp, title: "Data Visualization", desc: "Matplotlib, Seaborn" },
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-xl mb-8 max-w-2xl mx-auto">
                Join our comprehensive program and master data science with Python.
              </p>
